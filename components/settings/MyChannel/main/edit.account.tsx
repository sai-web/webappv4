...
import { ProfilePic, MainCredentialUpdate } from '../display'
import { ChannelTags, EditAccountButtons } from '../edit'
...
export const EditAccountDetails: React.FC<EditAccountProps> = ({
    setEditStatus
}) => {
